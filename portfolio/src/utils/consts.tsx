...
const ART: artwork[] = [
    ...
    {id:1, path:"3.JPG", link:"charcoal2", title: "Charcoal Still Life 2", medium: "charcoal on paper"
        ,blurb: "This is another charcoal still life I did, right after the first one actually. For this painting, rather than capturing complex shapes, I worked on my rendering, analyzing the textures of various objects, such as an aluminum spool or a faux cabbage. The cloth in the back adds a lot of shape and complexity to the piece that I really love, but sketching in the circles was definitely an experience."
    },
